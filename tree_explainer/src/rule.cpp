...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "tree_explainer/src/rule.pyx"
        ]
    },
    "module_name": "tree_explainer.src.rule"
}
END: Cython Metadata */
...
#define __PYX_HAVE__tree_explainer__src__rule
#define __PYX_HAVE_API__tree_explainer__src__rule
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* "tree_explainer/src/rule.pxd":23
...
static CYTHON_INLINE int __pyx_f_14tree_explainer_3src_4rule_check_rule(struct __pyx_t_14tree_explainer_3src_4rule_Rule *, std::vector<int> ); /*proto*/
static PyObject *__pyx_convert_vector_to_py_double(std::vector<double>  const &); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "tree_explainer.src.rule"
extern int __pyx_module_is_main_tree_explainer__src__rule;
int __pyx_module_is_main_tree_explainer__src__rule = 0;

/* Implementation of "tree_explainer.src.rule" */
...
static struct __pyx_t_14tree_explainer_3src_4rule_Rule __pyx_f_14tree_explainer_3src_4rule_create_rule(int __pyx_v_len_col, int __pyx_v_tree_index, int __pyx_v_leaf_index) {
  struct __pyx_t_14tree_explainer_3src_4rule_Rule __pyx_v_rule;
  struct __pyx_t_14tree_explainer_3src_4rule_Rule __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 */
  ...
  __Pyx_AddTraceback("tree_explainer.src.rule.create_rule", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
static void __pyx_f_14tree_explainer_3src_4rule_update_rule(struct __pyx_t_14tree_explainer_3src_4rule_Rule *__pyx_v_rule, int __pyx_v_index, double __pyx_v_lb, double __pyx_v_ub) {
  double __pyx_t_1;
  double __pyx_t_2;
  double __pyx_t_3;
  int __pyx_t_4;
 ...
 * 
 */
  __pyx_t_1 = __pyx_v_lb;
  __pyx_t_2 = (__pyx_v_rule->lbs[__pyx_v_index]);
 ...
 * @boundscheck(False)
 */
  __pyx_t_3 = __pyx_v_ub;
  __pyx_t_1 = (__pyx_v_rule->ubs[__pyx_v_index]);
...
static CYTHON_INLINE int __pyx_f_14tree_explainer_3src_4rule_check_rule(struct __pyx_t_14tree_explainer_3src_4rule_Rule *__pyx_v_rule, std::vector<int>  __pyx_v_feature_indices) {
  int __pyx_v_idx;
  int __pyx_r;
...
static CYTHON_INLINE int __pyx_f_14tree_explainer_3src_4rule_check_value(struct __pyx_t_14tree_explainer_3src_4rule_Rule *__pyx_v_rule, int __pyx_v_i, double __pyx_v_value) {
  int __pyx_r;
  int __pyx_t_1;
...
static std::vector<std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> >  __pyx_f_14tree_explainer_3src_4rule_filter_trees(std::vector<std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> >  __pyx_v_trees, int __pyx_v_main_col, struct __pyx_opt_args_14tree_explainer_3src_4rule_filter_trees *__pyx_optional_args) {
  int __pyx_v_sub_col = ((int)-1);
  struct __pyx_t_14tree_explainer_3src_4rule_Rule __pyx_v_rule;
  std::vector<std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> >  __pyx_v_filtered_trees;
  std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule>  __pyx_v_filtered_rules;
  std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule>  __pyx_v_tree;
  ...
  int __pyx_t_3;
  std::vector<std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> > ::iterator __pyx_t_4;
  std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> ::iterator __pyx_t_5;
  struct __pyx_t_14tree_explainer_3src_4rule_Rule __pyx_t_6;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
 ...
 *         for rule in tree:
 */
  __pyx_t_4 = __pyx_v_trees.begin();
  for (;;) {
    if (!(__pyx_t_4 != __pyx_v_trees.end())) break;
    __pyx_t_1 = *__pyx_t_4;
    ++__pyx_t_4;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("tree_explainer.src.rule.filter_trees", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_pretend_to_initialize(&__pyx_r);
  __pyx_L0:;
  return __pyx_r;
}
...
static std::vector<double>  __pyx_f_14tree_explainer_3src_4rule_get_split_point(std::vector<std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> >  __pyx_v_trees, int __pyx_v_col) {
  ...
  __Pyx_RefNannyDeclarations
  std::vector<std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> > ::iterator __pyx_t_1;
  std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule>  __pyx_t_2;
  std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> ::iterator __pyx_t_3;
  struct __pyx_t_14tree_explainer_3src_4rule_Rule __pyx_t_4;
 ...
 */
    __pyx_t_3 = __pyx_v_tree.begin();
    for (;;) {
      if (!(__pyx_t_3 != __pyx_v_tree.end())) break;
      __pyx_t_4 = *__pyx_t_3;
      ++__pyx_t_3;
 ...
 */
  ...
  __Pyx_AddTraceback("tree_explainer.src.rule.get_split_point", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_pretend_to_initialize(&__pyx_r);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("create_rule", (void (*)(void))__pyx_f_14tree_explainer_3src_4rule_create_rule, "struct __pyx_t_14tree_explainer_3src_4rule_Rule (int, int, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("update_rule", (void (*)(void))__pyx_f_14tree_explainer_3src_4rule_update_rule, "void (struct __pyx_t_14tree_explainer_3src_4rule_Rule *, int, double, double)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("check_rule", (void (*)(void))__pyx_f_14tree_explainer_3src_4rule_check_rule, "int (struct __pyx_t_14tree_explainer_3src_4rule_Rule *, std::vector<int> )") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("check_value", (void (*)(void))__pyx_f_14tree_explainer_3src_4rule_check_value, "int (struct __pyx_t_14tree_explainer_3src_4rule_Rule *, int, double)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("compare_rules", (void (*)(void))__pyx_f_14tree_explainer_3src_4rule_compare_rules, "int (struct __pyx_t_14tree_explainer_3src_4rule_Rule const &, struct __pyx_t_14tree_explainer_3src_4rule_Rule const &)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("get_split_point", (void (*)(void))__pyx_f_14tree_explainer_3src_4rule_get_split_point, "std::vector<double>  (std::vector<std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> > , int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("filter_trees", (void (*)(void))__pyx_f_14tree_explainer_3src_4rule_filter_trees, "std::vector<std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> >  (std::vector<std::vector<struct __pyx_t_14tree_explainer_3src_4rule_Rule> > , int, struct __pyx_opt_args_14tree_explainer_3src_4rule_filter_trees *__pyx_optional_args)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_rule(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_rule},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initrule(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initrule(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_rule(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_rule(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_rule(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'rule' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("rule", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  if (unlikely(!__pyx_m)) __PYX_ERR(1, 1, __pyx_L1_error)
  #elif CYTHON_USE_MODULE_STATE
  __pyx_t_1 = PyModule_Create(&__pyx_moduledef); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 1, __pyx_L1_error)
  {
    int add_module_result = PyState_AddModule(__pyx_t_1, &__pyx_moduledef);
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "rule" pseudovariable */
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_rule(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_tree_explainer__src__rule) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "tree_explainer.src.rule")) {
      if (unlikely((PyDict_SetItemString(modules, "tree_explainer.src.rule", __pyx_m) < 0))) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init tree_explainer.src.rule", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init tree_explainer.src.rule");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
